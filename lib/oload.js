...
class Openload {
    ...
    parsePage() {
        this._0x5d72cd = /<p style="" id="[a-zA-Z0-9]+">([a-zA-Z0-9]{100,})<\/p>/.exec(this.body)[1];
    ...
    getUrl() {
        return "https://openload.co/stream/" + this.stream + "?mime=true";
    }
}

// const Openload = require("openload-url");

new Openload().downloadPage("https://oload.stream/embed/a9dnCOiSYuk").then(ol => {
    ol.scrape();
